		...
		<tr>
			<td>
				<table width="70%"  border="0" align="center" class="heading6">
					...
					<form name="ajax-contact-form" id="ajax-contact-form" method="post" action="{{route('User_insert')}}" accept-charset="utf-8" enctype="multipart/form-data" onsubmit ="return validateForm()">
						<form  method="post" action="javascript:void(0)"  enctype="multipart/form-data" id="imageUpload">
							...
							<tr>
								...
								<td width="47%" align="left"><input name="userName" type="text"  maxlength="20" id="userName" size="35" value="{{old('userName')}}" placeholder="Enter User Name"><span class="userName_err" id="userName_err" style="color: red;"></span></td>

							</tr>
							<tr>
								<td align="right">Password*</td>
								<td align="center">:</td>
								<td align="left"><input name="password" id="password" placeholder="Enter Password" type="password" maxlength="20" size="35"value="{{old('password')}}"><span class="password_err" id="password_err" style="color: red;"></span></td>

							</tr>
							<tr>
								<td align="right">Confirm Password*</td>
								<td align="center">:</td>
								<td align="left"><input name="con_password" placeholder="Enter Confirm password" type="password" maxlength="20" id="con_password"size="35" value="{{old('con_password')}}"><span class="con_password_err" id="con_password_err" style="color: red;"></span></td>

							</tr>
							<tr>
								<td align="right">Email Address*</td>
								<td align="center">:</td>
								<td align="left"><input name="emailAddress" placeholder="Enter Email" type="email" maxlength="20" id="emailAddress" size="35" value="{{old('emailAddress')}}"><span class="emailAddress_err" id="emailAddress_err" style="color: red;"></span></td>

							</tr>
							<tr>
								<td align="right">Profile Image*</td>
								<td align="center">:</td>
								<td align="left"><input name="files" id="Profile_img" type="file" size="35" value="{{old('files')}}"> <span class="Profile_img_err" id="Profile_img_err"  style="color: red;"></span></td>
			...
			<script type="text/javascript">
				function validateForm(){
					...
					if (con_password=='') {
						...
						con_password_err = 'confirm password is required';
					}
					if (password != con_password){
						con_password_err =' Confirm password not matched ';
					}
					if (emailAddress=='') {
					...
					$('#con_password_err').html(con_password_err);
					$('#emailAddress_err').html(emailAddress_err);
					$('#Profile_img_err').html(Profile_img_err);
					$('#preferenceName_err').html(preferenceName_err);
					if (userName_err || password_err || con_password_err || emailAddress_err || Profile_img_err || preferenceName_err) {
